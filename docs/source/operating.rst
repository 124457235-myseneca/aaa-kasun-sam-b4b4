[aaa-kasun-sam-b4b4] Operating Details
====================================

Generated On: 2024-10-12 17:55:34 UTC
...
.. important::
   ...
   **not be valid if your [aaa-kasun-sam-b4b4] container is NOT running**.

.. tip::
   You must have your [aaa-kasun-sam-b4b4] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/124457235-myseneca/cyt160/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/124457235-myseneca/cyt160.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=41125  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='124457235-myseneca'  \-\-env DOCKERUSERNAME='kasunsam'  \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   kasunsam/aaa-kasun-sam-b4b4-amd64 (https://hub.docker.com/r/kasunsam/aaa-kasun-sam-b4b4-amd64)
...
.. important::
   docker run -d -p 41941:41941 -p 50695:50695 -p 54059:54059 \-\-env TSS=0 \-\-env SOLUTIONNAME=aaa-kasun-sam-b4b4 \-\-env SOLUTIONDAG=solution_preprocessing_dag-aaa-kasun-sam-b4b4 \-\-env GITUSERNAME=124457235-myseneca  \-\-env GITREPOURL=https://github.com/124457235-myseneca/cyt160.git \-\-env SOLUTIONEXTERNALPORT=41941  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=50695  \-\-env SOLUTIONVIPERVIZPORT=54059 \-\-env DOCKERUSERNAME='kasunsam'  \-\-env EXTERNALPORT=41125 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kasunsam/aaa-kasun-sam-b4b4-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=54059
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=41941
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - kasunsam/aaa-kasun-sam-b4b4-amd64
...
.. important::
   http://localhost:54059/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:54059/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:54059/<html file>
...
[aaa-kasun-sam-b4b4] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/124457235-myseneca/cyt160/tree/main/tml-airflow/dags/tml-solutions/aaa-kasun-sam-b4b4
...
.. important::
   https://aaa-kasun-sam-b4b4.readthedocs.io
...
.. important::
   solution_preprocessing_dag-aaa-kasun-sam-b4b4
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=41941, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=32971, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45649, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=37185, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=37897, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40247, HPDEHOST=127.0.1.1, HPDEPORT=44231, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=37647

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1882-aaa-kasun-sam-b4b4,solution_preprocessing_dag-aaa-kasun-sam-b4b4, python-preprocess-9993-aaa-kasun-sam-b4b4,solution_preprocessing_dag-aaa-kasun-sam-b4b4, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
